...
public class Project implements Modifications {
    ...
    public Object getFile(String filename) throws IOException, ClassParsingException {
        ...
        if (ByteToolkit.areEqual(classMagic, data, 4)) {
        	try {
        ...
        } else if (ByteToolkit.areEqual(serializedMagic, data, 2)) {
    ...
    public byte[] getData(String filename) throws IOException {
        try {
            return ((ClassFile)getFile(filename)).getData();
